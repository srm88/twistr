...
var cardTable = []struct {
	...
	{DuckAndCover, Early, false, USA, 4, "Duck and Cover", 3, "Degrade the DEFCON level by 1. The US receives VP equal to 5 minus the current DEFCON level."},
	{FiveYearPlan, Early, false, USA, 5, "Five Year Plan", 3, "The USSR must randomly discard a card. If the card has a US associated Event, the Event occurs immediately. If the card has a USSR associated Event or an Event applicable to both players, then the card must be discarded without triggering the Event."},
	...
	{TrumanDoctrine, Early, false, USA, 19, "Truman Doctrine*", 1, "Remove all USSR Influence from a single uncontrolled country in Europe."},
	...
	{IndependentReds, Early, false, USA, 22, "Independent Reds*", 2, "Add US Influence to either Yugoslavia, Romania, Bulgaria, Hungary, or Czechoslovakia so that it equals the USSR Influence in that country."},
	{MarshallPlan, Early, false, USA, 23, "Marshall Plan*", 4, "Add 1 US Influence to each of any 7 non-USSR controlled countries in Western Europe. This Event allows the “#21 – NATO” card to be played as an Event."},
	...
	{Containment, Early, false, USA, 25, "Containment*", 3, "All Operations cards played by the US, for the remainder of this turn, receive +1 to their Operations value (to a maximum of 4 Operations per card)."},
	{CIACreated, Early, false, USA, 26, "CIA Created*", 1, "The USSR reveals their hand of cards for this turn. The US may use the Operations value of this card to conduct Operations."},
	{USJapanMutualDefensePact, Early, false, USA, 27, "US/Japan Mutual Defense Pact*", 4, "The US adds sufficient Influence to Japan for Control. The USSR cannot make Coup Attempts or Realignment rolls against Japan."},
	...
	{EastEuropeanUnrest, Early, false, USA, 29, "East European Unrest", 3, "Early or Mid War: Remove 1 USSR Influence from 3 countries in Eastern Europe. Late War: Remove 2 USSR Influence from 3 countries in Eastern Europe."},
	...
	{FormosanResolution, Early, false, USA, 35, "Formosan Resolution*", 2, "If this card’s Event is in effect, Taiwan will be treated as a Battleground country, for scoring purposes only, if Taiwan is US controlled when the Asia Scoring Card is played. This Event is cancelled after the US has played the “#6 – The China Card” card."},
	{Defectors, Early, false, USA, 103, "Defectors", 2, "The US may play this card during the Headline Phase in order to cancel the USSR Headline Event (including a scoring card). The canceled card is placed into the discard pile. If this card is played by the USSR during its action round, the US gains 1 VP."},
	...
	{NuclearSubs, Mid, false, USA, 41, "Nuclear Subs*", 2, "US Operations used for Coup Attempts in Battleground countries, for the remainder of this turn, do not degrade the DEFCON level. This card’s Event does not apply to any Event that would affect the DEFCON level (ex. the “#40 – Cuban Missile Crisis” Event)."},
	...
	{KitchenDebates, Mid, false, USA, 48, "Kitchen Debates*", 1, "If the US controls more Battleground countries than the USSR, the US player uses this Event to poke their opponent in the chest and receive 2 VP!"},
	...
	{ColonialRearGuards, Mid, false, USA, 63, "Colonial Rear Guards", 2, "Add 1 US Influence to each of any 4 countries in Africa and/or Southeast Asia."},
	{PanamaCanalReturned, Mid, false, USA, 64, "Panama Canal Returned*", 1, "Add 1 US Influence to Panama, Costa Rica and Venezuela."},
	{CampDavidAccords, Mid, false, USA, 65, "Camp David Accords*", 2, "The US receives 1 VP and adds 1 Influence to Israel, Jordan and Egypt. This Event prevents the “#13 – Arab-Israeli War” card from being played as an Event."},
	{PuppetGovernments, Mid, false, USA, 66, "Puppet Governments*", 2, "The US may add 1 Influence to 3 countries that do not contain Influence from either the US or USSR."},
	...
	{JohnPaulIIElectedPope, Mid, false, USA, 68, "John Paul II Elected Pope*", 2, "Remove 2 USSR Influence from Poland and add 1 US Influence to Poland. This Event allows the “#101 – Solidarity” card to be played as an Event."},
	...
	{OASFounded, Mid, false, USA, 70, "OAS Founded*", 1, "Add a total of 2 US Influence to any countries in Central or South America."},
	{NixonPlaysTheChinaCard, Mid, false, USA, 71, "Nixon Plays the China Card*", 2, "If the USSR has the “#6 – The China Card” card, the USSR must give the card to the US (face down and unavailable for immediate play). If the US already has the “#6 – The China Card” card, the US receives 2 VP."},
	{SadatExpelsSoviets, Mid, false, USA, 72, "Sadat Expels Soviets*", 1, "Remove all USSR Influence from Egypt and add 1 US Influence to Egypt."},
	{ShuttleDiplomacy, Mid, false, USA, 73, "Shuttle Diplomacy", 3, "If this card’s Event is in effect, subtract (-1) a Battleground country from the USSR total and then discard this card during the next scoring of the Middle East or Asia (which ever comes first)."},
	{TheVoiceOfAmerica, Mid, false, USA, 74, "The Voice of America", 2, "Remove 4 USSR Influence from any countries NOT in Europe (removing no more than 2 Influence per country)."},
	...
	{AllianceForProgress, Mid, false, USA, 78, "Alliance for Progress*", 3, "The US receives 1 VP for each US controlled Battleground country in Central and South America."},
	...
	{TheIronLady, Late, false, USA, 83, "The Iron Lady*", 3, "Add 1 USSR Influence to Argentina and remove all USSR Influence from the United Kingdom. The US receives 1 VP. This Event prevents the “#7 – Socialist Governments” card from being played as an Event."},
	{ReaganBombsLibya, Late, false, USA, 84, "Reagan Bombs Libya*", 2, "The US receives 1 VP for every 2 USSR Influence in Libya."},
	{StarWars, Late, false, USA, 85, "Star Wars*", 2, "If the US is ahead on the Space Race Track, the US player uses this Event to look through the discard pile, pick any 1 non-scoring card and play it immediately as an Event."},
	{NorthSeaOil, Late, false, USA, 86, "North Sea Oil*", 3, "The US may play 8 cards (in 8 action rounds) for this turn only. This Event prevents the “#61 – OPEC” card from being played as an Event."},
	...
	{SovietsShootDownKAL007, Late, false, USA, 89, "Soviets Shoot Down KAL-007*", 4, "Degrade the DEFCON level by 1 and the US receives 2 VP. The US may place influence or make Realignment rolls, using this card, if South Korea is US controlled."},
	...
	{Chernobyl, Late, false, USA, 94, "Chernobyl*", 3, "The US must designate a single Region (Europe, Asia, etc.) that, for the remainder of the turn, the USSR cannot add Influence to using Operations points."},
	...
	{TearDownThisWall, Late, false, USA, 96, "Tear Down this Wall*", 3, "Add 3 US Influence to East Germany. The US may make free Coup Attempts or Realignment rolls in Europe using the Operations value of this card. This Event prevents / cancels the effect(s) of the “#55 – Willy Brandt” Event."},
	{AnEvilEmpire, Late, false, USA, 97, "“An Evil Empire”*", 3, "The US receives 1 VP. This Event prevents / cancels the effect(s) of the “#59 – Flower Power” Event."},
	...
	{Solidarity, Late, false, USA, 101, "Solidarity*", 2, "Add 3 US Influence to Poland. This card requires prior play of the “#68 – John Paul II Elected Pope” Event in order to be played as an Event."},
	...
	{NORAD, Early, true, USA, 106, "NORAD", 3, "Add 1 US Influence to a single country containing US Influence, at the end of each Action Round, if Canada is US-controlled and the DEFCON level moved to 2 during that Action Round. This Event is canceled by the “#42 – Quagmire” Event."},
	...
	{AWACSSaleToSaudis, Late, true, USA, 110, "AWACS Sale to Saudis*", 3, "Add 2 US Influence to Saudi Arabia. This Event prevents the “#56 – Muslim Revolution” card from being played as an Event."},
}
